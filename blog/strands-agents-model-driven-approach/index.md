...
tags: ["Model-Driven", "Architecture", "Best Practices"]
---
...
![Agent definition diagram](/_astro/model-driven-prompt-diagram.Ccugn9J1_1sS2Pw.webp)
...
![Agent architecture — isolated tools](/_astro/model-driven-architecture-3.CpmKh103_Zxxjkr.webp)
...
![Agent architecture — return of control](/_astro/model-driven-architecture-4.DjMVZVEM_ZHnbNz.webp)
...
Ready to try it? Check out the [Strands Agents documentation](/index.md) and [examples](/docs/examples/index.md) to start building your own model-driven agents.