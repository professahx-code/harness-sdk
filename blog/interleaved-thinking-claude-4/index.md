...
If you enable [tracing with Strands](/docs/user-guide/observability-evaluation/traces/index.md), you’ll see additional blocks of “reasoningContent” in your trace, like in the following image, including reasoning when Claude 4 decides to interleave thinking after tool calls.

![Reasoning content example showing model invocation with interleaved thinking](/_astro/model-invoke-reasoning.DLL5TRBq_ZnNPQR.webp)
