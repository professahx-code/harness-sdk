...
The [agents-as-tools](/docs/user-guide/concepts/multi-agent/agents-as-tools/index.md) pattern transforms specialized agents into intelligent tools that other agents can call, enabling hierarchical delegation where agents acting as the orchestrator dynamically consult domain experts without giving up control of the request. This mirrors how human teams work—a project manager doesn’t need to know everything, they just need to know which specialist to consult for each task.
...
Learn more about [Graphs](/docs/user-guide/concepts/multi-agent/graph/index.md) in the Strands documentation.
...
Learn more about [Native Async Support](/docs/user-guide/concepts/streaming/async-iterators/index.md) in the documentation.
