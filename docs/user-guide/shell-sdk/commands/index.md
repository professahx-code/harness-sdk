...
The SSRF guard and credential injection on `curl` are security features, covered in the [security model](/docs/user-guide/shell-sdk/security/index.md). They are not optional and cannot be disabled per command.
