...
This starts a bare in-memory sandbox: no host files, no network, no credentials. To grant access, write a [TOML config file](/docs/user-guide/shell-sdk/configuration/index.md#toml-configuration) and pass it before the `--mcp` flag:
...
-   [Security Model](/docs/user-guide/shell-sdk/security/index.md): what the sandbox guarantees, what it does not, and when to add OS-level isolation.
