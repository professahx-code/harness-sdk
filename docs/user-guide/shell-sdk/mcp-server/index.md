...
-   [Configuration](/docs/user-guide/shell-sdk/configuration/index.md): the full TOML schema for binds, credentials, the allowlist, and limits.
-   [Security Model](/docs/user-guide/shell-sdk/security/index.md): what the sandbox guarantees per session and why one shell per session is the contract.