...
The [Configuration](/docs/user-guide/shell-sdk/configuration/index.md) guide covers each of these in depth, including the TOML format that lets you declare the whole policy in a file.
...
-   [Quickstart](/docs/user-guide/shell-sdk/quickstart/index.md): install the shell and run your first sandboxed command through MCP, Python, or Node.js.
-   [Configuration](/docs/user-guide/shell-sdk/configuration/index.md): bind directories, inject credentials, set the network allowlist, and load it all from TOML.
-   [Commands](/docs/user-guide/shell-sdk/commands/index.md): the full command inventory, supported flags, and known gaps versus GNU coreutils.
-   [MCP Server](/docs/user-guide/shell-sdk/mcp-server/index.md): expose the shell to any MCP-compatible agent framework over stdio.
-   [Security Model](/docs/user-guide/shell-sdk/security/index.md): the Kernel boundary, the SSRF guard, credential handling, and how to layer OS isolation for adversarial workloads.