...
TypeScript does not support callback handlers. For real-time event handling in TypeScript, use the [async iterator pattern](/docs/user-guide/concepts/streaming/async-iterators/index.md) with `agent.stream()` or see [Hooks](/docs/user-guide/concepts/agents/hooks/index.md) for lifecycle event handling.
...
> **Note:** For asynchronous applications, consider [async iterators](/docs/user-guide/concepts/streaming/async-iterators/index.md) instead.
