...
-   `model`: Model identifier (string) - \[[Only supports AWS Bedrock model provider string](/docs/user-guide/quickstart/index.md#using-a-string-model-id)\]
