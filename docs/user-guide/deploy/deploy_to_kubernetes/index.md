...
The following assume you have completed the [Docker deployment guide](/docs/user-guide/deploy/deploy_to_docker/index.md) with the following file structure:
