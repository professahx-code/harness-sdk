...
[Complete User Simulation Guide →](/docs/user-guide/evals-sdk/simulators/user_simulation/index.md)
...
-   [User Simulation Guide](/docs/user-guide/evals-sdk/simulators/user_simulation/index.md): Simulate multi-turn user conversations
-   [Tool Simulation Guide](/docs/user-guide/evals-sdk/simulators/tool_simulation/index.md): Simulate tool behavior with LLM-powered responses
-   [Evaluators](/docs/user-guide/evals-sdk/evaluators/output_evaluator/index.md): Combine with evaluators
