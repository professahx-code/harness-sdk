...
See [Writing Custom Cases](/docs/user-guide/evals-sdk/red-teaming/custom_cases/index.md) to author cases by hand instead.
...
See [Reading the Report](/docs/user-guide/evals-sdk/red-teaming/reading_the_report/index.md) for the full breakdown of the matrix, the worst-first table, the `AttackResult` fields, and what to do when an attack breaches.
