...
Defined in: [src/session/session-manager.ts:43](https://github.com/strands-agents/harness-sdk/blob/d9b9061486aa20414699f47b5b1caddccb3e0dff/strands-ts/src/session/session-manager.ts#L43)
