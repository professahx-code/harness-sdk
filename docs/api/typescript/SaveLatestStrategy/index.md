...
Defined in: [src/session/session-manager.ts:43](https://github.com/strands-agents/harness-sdk/blob/49d797ae86485bd24e3e86744b6b959ccc8b9a12/strands-ts/src/session/session-manager.ts#L43)
