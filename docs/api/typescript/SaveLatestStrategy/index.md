...
Defined in: [src/session/session-manager.ts:43](https://github.com/strands-agents/harness-sdk/blob/c04fdd821ea0e816a78fdf2e3f95201e3cfa84c5/strands-ts/src/session/session-manager.ts#L43)
